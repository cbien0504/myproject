...
# #     StructField("review_image", ArrayType(StringType()), True)
# # ])))
...
#         F.col('review.author.name').alias('review_author_name'),
#         F.col('review.datePublished').alias('review_date'),
#         F.col('review.description').alias('review_description'),
#         F.col('review.reviewBody').alias('review_body'),
#         F.col('review.reviewRating.bestRating').alias('review_best_rating'),
#         F.col('review.reviewRating.ratingValue').alias('review_rating_value'),
#         F.col('review.image').alias('review_image')
#     )